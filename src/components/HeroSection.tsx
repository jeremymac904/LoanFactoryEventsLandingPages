  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
        {/* VIP Tag */}
        <div className="animate-fade-in-up inline-flex items-center gap-2 bg-lf-orange/20 border border-lf-orange/40 rounded-full px-6 py-2 mb-8">
        ...
        <div className="animate-fade-in-up animate-delay-400">
          <a
            href="#rsvp-form"
            className="inline-flex items-center gap-3 bg-lf-orange hover:bg-lf-orange-dark text-white font-extrabold text-lg py-4 px-10 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-2xl shadow-lf-orange/30 hover:shadow-lf-orange/50"
          >
            {t.heroCta}
